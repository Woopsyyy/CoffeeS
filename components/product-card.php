...
if (!function_exists('renderProductCard')) {
    function renderProductCard($product) {
        ...
        $imageMap = [
            ...
            'Caffe Mocha' => 'https://images.unsplash.com/photo-1607687325211-ac62326303af?q=80&w=600',
            'Affogato' => 'https://images.unsplash.com/photo-1592318780016-5bc77b94dbba?q=80&w=600',
